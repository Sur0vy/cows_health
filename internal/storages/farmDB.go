...
//	"encoding/json"
//	"fmt"
//	"github.com/Sur0vy/cows_health.git/internal"
...
//}
//
//func (s *DBStorage) GetFarms(c context.Context, userID int) ([]models.Farm, error) {
//	ctxIn, cancel := context.WithTimeout(c, 5*time.Second)
//	defer cancel()
//
//	var farms []models.Farm
//	sqlStr := fmt.Sprintf("SELECT %s, %s, %s FROM %s WHERE %s = $1 AND NOT %s",
//		internal.FFarmID, internal.FName, internal.FAddress, internal.TFarm, entity.FUserID, entity.FDeleted)
...
//}
//
//func (s *DBStorage) AddFarm(c context.Context, farm models.Farm) error {
//	ctxIn, cancel := context.WithTimeout(c, 2*time.Second)
//	defer cancel()
//
//	var userID int
//	sqlStr := fmt.Sprintf("SELECT %s FROM %s WHERE %s = $1",
//		internal.FFarmID, internal.TFarm, internal.FAddress)
...
//		internal.TFarm, internal.FName, internal.FAddress, entity.FUserID)
...
//		internal.TFarm, entity.FDeleted, internal.FFarmID, entity.FDeleted)
//
